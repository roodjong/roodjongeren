...
export default function AfdelingenPage(props: Props) {
    ...
    return (
        <div>
            <HeadPage
                title="Afdelingen"
                description="Overzicht van alle afdelingen van ROOD"
            ...
            <Main>
                <div className="container">
                    ...
                    <p className="my-4">
                        Wij hebben {props.afdelingen.length} afdelingen verspreid over
                        Nederland. Kijk op de kaart of er een afdeling bij jou in de buurt
                        is, of begin er één!
                    </p>
